...
public final class RhythmnormalBinding implements ViewBinding {
  @NonNull
  ...
  private RhythmnormalBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnback,
  ...
  @NonNull
  public static RhythmnormalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RhythmnormalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.rhythmnormal, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RhythmnormalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RhythmnormalBinding((ConstraintLayout) rootView, btnback, btnpause, btnstart,
          tvbad, tvex, tvgood, tvgreat);
    }
